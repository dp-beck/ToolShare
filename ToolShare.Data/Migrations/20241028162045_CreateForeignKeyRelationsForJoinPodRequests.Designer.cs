...
namespace ToolShare.Data.Migrations
{
    ...
    [Migration("20241028162045_CreateForeignKeyRelationsForJoinPodRequests")]
    partial class CreateForeignKeyRelationsForJoinPodRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToolShare.Data.Models.AppUser", b =>
                {
                    ...
                    b.Property<int?>("PodJoinedId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("PodManagedId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("joinPodRequestsentId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PodJoinedId");

                    b.HasIndex("PodManagedId")
                        .IsUnique();

                    b.HasIndex("joinPodRequestsentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ToolShare.Data.Models.AppUser", b =>
                {
                    b.HasOne("ToolShare.Data.Models.Pod", "PodJoined")
                        .WithMany("PodMembers")
                        .HasForeignKey("PodJoinedId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ToolShare.Data.Models.Pod", "PodManaged")
                        .WithOne("podManager")
                        .HasForeignKey("ToolShare.Data.Models.AppUser", "PodManagedId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ToolShare.Data.Models.JoinPodRequest", "joinPodRequestSent")
                        .WithOne("Requester")
                        .HasForeignKey("ToolShare.Data.Models.AppUser", "joinPodRequestsentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("PodJoined");

                    b.Navigation("PodManaged");

                    b.Navigation("joinPodRequestSent");
                });

            modelBuilder.Entity("ToolShare.Data.Models.JoinPodRequest", b =>
                {
                    b.HasOne("ToolShare.Data.Models.AppUser", "Receiver")
                        .WithMany("JoinPodRequestsReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToolShare.Data.Models.Pod", "podRequested")
                        .WithMany("requestsToJoin")
                        .HasForeignKey("podRequestedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Receiver");

                    b.Navigation("podRequested");
                });
            ...
            modelBuilder.Entity("ToolShare.Data.Models.AppUser", b =>
                {
                    b.Navigation("JoinPodRequestsReceived");
